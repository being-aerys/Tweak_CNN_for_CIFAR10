...
if __name__ == "__main__":
    ...
    for epoch in range(MAX_EPOCH):  # loop over the data set multiple times
        ...
        plt.title("Number of Epochs VS Accuracies Q1 without Batch Normalization")
        plt.grid()
        ...
        plt.title("Number of Epochs vs Loss Q1 without Batch Normalization")
        plt.grid()
    ...
    torch.save(net.state_dict(), 'mytraining1a.pth')
